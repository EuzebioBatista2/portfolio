...
export default function AboutMe() {
    return (
        <section id='AboutMe' className={`relative overflow-hidden h-[560px] w-full pt-16`}>
            <h1 className="flex items-center justify-center text-3xl font-bold text-gray-200 dark:text-black">
                    <i>{IconBook}</i> &nbsp; Sobre mim
            </h1>
            <div className="w-4/5 absolute top-32 left-14 self-end z-10">
                <img src="./images/me.png" 
                    className={`
                        bg-gray-500 dark:bg-gray-200
                        border-2 border-gray-200 dark:border-gray-700 border-dashed rounded-md`}/>
            </div>
            <img src="./images/react.png" className="flex absolute top-56 left-44 h-64 z-0" />
