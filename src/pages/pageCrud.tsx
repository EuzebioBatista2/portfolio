    ...
    <main className={`${darkTheme ? 'dark' : ''} flex flex-col overflow-hidden h-screen min-h-[650px] w-full`}>
      ...
      <LayoutNavigation>
        ...
        <div className="flex w-3/5 items-center justify-center">
          <h1 className="text-1xl font-semibold text-black dark:text-gray-200">Pagina CRUD</h1>
        </div>
      ...
      <div className="flex flex-col items-center justify-center  md:flex-row gap-2 bg-gray-200 dark:bg-gray-800 transition duration-500 ease-in-out w-full h-full px-2 relative">
        ...
        <VideoPlay className="h-full md:h-3/4 md:w-1/2 w-full mt-14 z-10" link="CwI7wXdqGRw" />
        ...
        <div className="flex flex-col items-center justify-start md:justify-center w-full h-1/2 md:h-full md:w-1/2 gap-4 pb-2 z-10">
          <p className="text-black dark:text-white">Projeto criado com o intuito de representar uma página no qual realiza as principais requisições web que
            são: <strong>GET</strong>, <strong>POST</strong>, <strong>PUT</strong> e <strong>DELETE</strong> para mais informações
            acesse meu GitHub.
          </p>
          <Button name="GitHub" color="gray" icon={IconGitHub(false)} link="https://github.com/EuzebioBatista2/ProjetoPaginaWeb" />
        </div>
      </div>
    </main>
  )
