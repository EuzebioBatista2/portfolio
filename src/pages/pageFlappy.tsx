  ...
  return (
    <main className={`${darkTheme ? 'dark' : ''} flex flex-col overflow-hidden h-screen min-h-[650px] w-full`}>
      ...
      <div className="flex flex-col items-center justify-center  md:flex-row gap-2 bg-gray-200 dark:bg-gray-800 transition duration-500 ease-in-out w-full h-full px-2 relative">
        ...
        <VideoPlay className="h-full md:h-3/4 md:w-1/2 w-full mt-14 z-10" link="1ugzMbzTcbA" />
        ...
        <div className="flex flex-col items-center justify-start md:justify-center w-full h-1/2 md:h-full md:w-1/2 gap-4 pb-2 z-10">
          <p className="text-black dark:text-white">
            replica de um <strong>FLAPPYBIRD</strong> com um sistema de rank, onde o "player" pode jogar representando sua linguagem de escolha e
            disputar com outros jogadores através do rank que informado a pontuação dos melhores jogadores.
          </p>
          <Button name="GitHub" color="gray" icon={IconGitHub(false)} link="https://github.com/EuzebioBatista2/flappybird-program-languages" />
        </div>
      </div>
    </main>
  )
