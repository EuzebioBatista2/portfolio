      ...
      <motion.div ref={ref13} initial={{ opacity: 0, x: -50 }} animate={{ opacity: inView13 ? 1 : 0, x: inView13 ? 0 : 50 }} transition={{ duration: 0.5 }}>
        ...
        <div className="p-2">
          <p>
            ...
            <strong className="text-gray-700">#ReactJs</strong>, <strong className="text-gray-700">#NextJs</strong>, <strong className="text-gray-700">#Tailwind</strong>, <strong className="text-gray-700">#TypeScript</strong>, <strong className="text-gray-700">#VueJs</strong>, <strong className="text-gray-700">#Bootstrap</strong>, <strong className="text-gray-700">#Git/GitHub</strong>, <strong className="text-gray-700">#Jquery</strong>, <strong className="text-gray-700">#Laravel</strong>. e <strong className="text-gray-700">#NodeJs</strong>.<br />
            <br />
